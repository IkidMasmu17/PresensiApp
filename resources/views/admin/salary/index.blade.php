...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 space-y-4 md:space-y-0">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Management Salary</h1>
            <p class="text-slate-500 mt-1">Kelola rincian gaji, insentif, dan riwayat pembayaran karyawan.</p>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50/50">
                    <tr>
                        ...
                        <th scope="col"
                            class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Period
                        </th>
                        <th scope="col"
                            class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Amount
                        </th>
                        <th scope="col"
                        ...
                        <tr class="hover:bg-gray-50/50 transition duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-bold text-gray-900">
                                    Rp {{ number_format($salary->amount) }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                ...
                                <form action="{{ url('salary/' . $salary->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
