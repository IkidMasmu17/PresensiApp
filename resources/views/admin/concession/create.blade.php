...
@section('content')
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Add New Concession</h1>
            <p class="text-slate-500 mt-1">Daftarkan pengajuan izin, sakit, atau cuti karyawan.</p>
        </div>
    </div>
    ...
    <div class="max-w-2xl bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8">
            <form action="{{ url('concession') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea name="description" rows="4" placeholder="Briefly explain the reason..."
